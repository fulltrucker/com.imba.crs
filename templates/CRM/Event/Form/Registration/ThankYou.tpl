...
<div class="crm-event-id-{$event.id} crm-block crm-event-thankyou-form-block">
    ...
    {if $form.region_contact_id}
        <div class="crm-group regional_support-group">
            <div class="header-dark">Regional Support</div>
            <div class="crm-section no-label regional_support-section">
                <div class="content">{$form.region_contact_id.html}</div>
                <div class="clear"></div>
            </div>
        </div>
    {/if}
