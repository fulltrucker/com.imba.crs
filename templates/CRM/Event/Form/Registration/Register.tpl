    ...
    {if $form.region_contact_id}
      <fieldset class="crm-group">
        ...
        <div class="crm-section">
          <div class="label"></div>
          <div class="content">Please select the IMBA region you would like your donation to support.</div>
          <div class="clear"></div>
          <div class="label">
